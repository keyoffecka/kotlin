 ...
 * Basically, this is very light-weight {@link PsiElement} with far fewer members.
 * Only members that are required for code generation are left here.
 * Unfortunately, we cannot retrofit {@link PsiElement} to implement this interface.
 * However, {@link KtElement} implements this interface.
 */
