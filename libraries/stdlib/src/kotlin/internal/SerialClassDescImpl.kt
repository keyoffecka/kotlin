...
class SerialClassDescImpl(override val name: String) : KSerialClassDesc {
    ...
    override fun getElementIndex(name: String): Int = indices[name] ?: throw IllegalArgumentException("Unkown name '$name'")
